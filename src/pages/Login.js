...
const Login = () => {
  ...
  return (
    <section className="flex flex-col items-center">
      <h2 className="text-primary-color text-3xl sm:text-6xl font-bold mt-[110px]">Eligöten.</h2>
      <form noValidate className="flex flex-col gap-5 max-w-[535px] w-[90%] text-md sm:text-2xl" onSubmit={handleSubmit(onSubmitHandler)}>
        <div className="flex flex-col mt-[88px]">
          ...
          <input
            ...
            className={`bg-primary-input p-4 focus:outline-text-primary-color mt-2 ${errors.username && "shake"}`}
            type="text"
            id="username"
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className={`bg-primary-input p-4 focus:outline-text-primary-color mt-2 ${errors.password && "shake"}`}
            type="password"
            id="password"
        ...
        <AnimatePresence>
          {errMsgFromServer && (
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center text-[1rem] text-red-600">
              {errMsgFromServer}
            </motion.p>
          )}
        </AnimatePresence>
